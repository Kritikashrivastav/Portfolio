...
function Navbar({ scrollToSection, refs }) {
  ...
  const navbarClasses = `
    fixed z-[999] w-full px-6 md:px-20 py-2 
    text-zinc-500 font-lato 
  ...
  const menuClasses = `
    ...
    fixed top-0 left-0 h-screen md:h-full w-full md:w-2/3
    text-zinc-500 flex flex-col gap-20 px-5 py-10
